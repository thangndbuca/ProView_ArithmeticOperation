...
Patterns.namespace("ProView").History = (function () {
    ...
    var push = function (state, name) {
        pushingState = true;
        History.pushState(null, name || "ProView shop", state);
    }

    // resplace current state on history stack
    var replace = function (state, name) {
        pushingState = true;
        History.replaceState(null, name || "ProView shop", state);
    }
...
Patterns.namespace("ProView").Utils = (function () {
...
Patterns.namespace("ProView").App = (function () {
